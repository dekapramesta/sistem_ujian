                                ...
                                <div class="modal" id="edit{{ $jurusan->identitas }}" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST"
                                                action="{{ route('admin.jurusan.edit', $jurusan->identitas) }}">
                                                @csrf
                                                @method('PUT')
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"
                                                                name="nama_jurusan_edit"
                                                                value="{{ $jurusan->nama_jurusan }}">
                                                            @error('nama_jurusan_edit')
                                ...
                                <div class="modal" id="delete{{ $jurusan->identitas }}" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST"
                                                action="{{ route('admin.jurusan.delete', $jurusan->identitas) }}">
                                                @csrf
                                                @method('delete')
                                                <div class="modal-body">
